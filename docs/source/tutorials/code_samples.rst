...
- :ref:`RGB video` - Demonstrates how to use the video output of the RGB camera
- :ref:`Mono video` - Demonstrates how to use the video output of the mono cameras
...
- :ref:`RGB Encoding & Mono with MobilenetSSD & Depth` - A combination of **04** and **10** code samples
- :ref:`Video & MobilenetSSD` - Runs MobileNetSSD on the video from the host
- :ref:`RGB Encoding with MobilenetSSD` - Runs MobileNetSSD on RGB frames and encodes FUll-HD RGB into :code:`.h265` and saves it on the host
