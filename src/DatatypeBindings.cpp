...
void DatatypeBindings::bind(pybind11::module& m){
    ...
    py::class_<CameraInfo> (m, "CameraInfo", DOC(dai, CameraInfo))
        ...
        .def_readwrite("cameraData", &CameraInfo::cameraData)
        .def_readwrite("stereoRectificationData", &CameraInfo::stereoRectificationData)
        .def_readwrite("imuExtrinsics", &CameraInfo::imuExtrinsics)
        ;
