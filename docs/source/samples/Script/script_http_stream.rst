...
.. tabs::
    ...
    .. tab:: Python
        ...
        Also `available on GitHub <https://github.com/luxonis/depthai-python/blob/main/examples/Script/script_http_stream.py>`__

        .. literalinclude:: ../../../../examples/Script/script_http_stream.py
           :language: python
           :linenos:

    .. tab:: C++

        Also `available on GitHub <https://github.com/luxonis/depthai-core/blob/main/examples/src/Script/script_http_stream.cpp>`__

        .. literalinclude:: ../../../../depthai-core/examples/src/Script/script_http_stream.cpp
           :language: cpp
           :linenos:
