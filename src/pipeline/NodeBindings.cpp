...
void NodeBindings::bind(pybind11::module& m){
    ...
    py::enum_<IMUSensorId>(m, "IMUSensorId")
        .value("RAW_ACCELEROMETER", IMUSensorId::RAW_ACCELEROMETER)
        .value("ACCELEROMETER", IMUSensorId::ACCELEROMETER)
        .value("LINEAR_ACCELERATION", IMUSensorId::LINEAR_ACCELERATION)
        .value("GRAVITY", IMUSensorId::GRAVITY)
        .value("RAW_GYROSCOPE", IMUSensorId::RAW_GYROSCOPE)
        .value("GYROSCOPE_CALIBRATED", IMUSensorId::GYROSCOPE_CALIBRATED)
        .value("GYROSCOPE_UNCALIBRATED", IMUSensorId::GYROSCOPE_UNCALIBRATED)
        .value("RAW_MAGNETOMETER", IMUSensorId::RAW_MAGNETOMETER)
        .value("MAGNETOMETER_CALIBRATED", IMUSensorId::MAGNETOMETER_CALIBRATED)
        .value("MAGNETOMETER_UNCALIBRATED", IMUSensorId::MAGNETOMETER_UNCALIBRATED)
        .value("ROTATION_VECTOR", IMUSensorId::ROTATION_VECTOR)
        .value("GAME_ROTATION_VECTOR", IMUSensorId::GAME_ROTATION_VECTOR)
        .value("GEOMAGNETIC_ROTATION_VECTOR", IMUSensorId::GEOMAGNETIC_ROTATION_VECTOR)
        .value("ARVR_STABILIZED_ROTATION_VECTOR", IMUSensorId::ARVR_STABILIZED_ROTATION_VECTOR)
        .value("ARVR_STABILIZED_GAME_ROTATION_VECTOR", IMUSensorId::ARVR_STABILIZED_GAME_ROTATION_VECTOR)
        .value("GYRO_INTEGRATED_ROTATION_VECTOR", IMUSensorId::GYRO_INTEGRATED_ROTATION_VECTOR)
    ;
