...
class PointCloudVisualizer():
    ...
    def visualize_pcd(self):
        if not self.isstarted:
            ...
            origin = o3d.geometry.TriangleMesh.create_coordinate_frame(size=0.0001, origin=[0, 0, 0])
            ...
            #o3d.io.write_point_cloud("points.ply", self.pcl, write_ascii=True)  #create a pointcloud file
