...
void DeviceBindings::bind(pybind11::module& m, void* pCallstack){
    ...
    deviceBase
        ...
        .def("getCameraTemperature", [](DeviceBase& d, CameraBoardSocket s) { py::gil_scoped_release release; return d.getCameraTemperature(s); }, py::arg("socket"), DOC(dai, DeviceBase, getCameraTemperature))
        .def("getCameraTemperature", [](DeviceBase& d, std::string n) { py::gil_scoped_release release; return d.getCameraTemperature(n); }, py::arg("name"), DOC(dai, DeviceBase, getCameraTemperature, 2))
