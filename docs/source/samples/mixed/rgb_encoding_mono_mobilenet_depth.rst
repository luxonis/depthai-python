...
.. tabs::
    ...
    .. tab:: C++
        ...
        Also `available on GitHub <https://github.com/luxonis/depthai-core/blob/main/examples/src/mixed/rgb_encoding_mono_mobilenet_depth.cpp>`__

        .. literalinclude:: ../../../../depthai-core/examples/src/mixed/rgb_encoding_mono_mobilenet_depth.cpp
           :language: cpp
           :linenos:
