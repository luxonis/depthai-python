...
void NodeBindings::bind(pybind11::module& m){
    ...
    py::class_<IMU, Node, std::shared_ptr<IMU>>(m, "IMU", DOC(dai, node, IMU))
        ...
        .def("enableIMUSensor", static_cast<void(IMU::*)(IMUSensorConfig imuSensor)>(&IMU::enableIMUSensor), py::arg("imuSensor"), DOC(dai, node, IMU, enableIMUSensor))
        .def("enableIMUSensor", static_cast<void(IMU::*)(const std::vector<IMUSensorConfig>& imuSensors)>(&IMU::enableIMUSensor), py::arg("imuSensors"), DOC(dai, node, IMU, enableIMUSensor, 2))
        .def("enableIMUSensor", static_cast<void(IMU::*)(const std::vector<IMUSensor>& sensors, uint32_t reportRate)>(&IMU::enableIMUSensor), py::arg("sensors"), py::arg("reportRate"), DOC(dai, node, IMU, enableIMUSensor, 3))
    ...
    py::enum_<IMUSensor>(m, "IMUSensor")
        .value("RAW_ACCELEROMETER", IMUSensor::RAW_ACCELEROMETER)
        .value("ACCELEROMETER", IMUSensor::ACCELEROMETER)
        .value("LINEAR_ACCELERATION", IMUSensor::LINEAR_ACCELERATION)
        .value("GRAVITY", IMUSensor::GRAVITY)
        .value("RAW_GYROSCOPE", IMUSensor::RAW_GYROSCOPE)
        .value("GYROSCOPE_CALIBRATED", IMUSensor::GYROSCOPE_CALIBRATED)
        .value("GYROSCOPE_UNCALIBRATED", IMUSensor::GYROSCOPE_UNCALIBRATED)
        .value("RAW_MAGNETOMETER", IMUSensor::RAW_MAGNETOMETER)
        .value("MAGNETOMETER_CALIBRATED", IMUSensor::MAGNETOMETER_CALIBRATED)
        .value("MAGNETOMETER_UNCALIBRATED", IMUSensor::MAGNETOMETER_UNCALIBRATED)
        .value("ROTATION_VECTOR", IMUSensor::ROTATION_VECTOR)
        .value("GAME_ROTATION_VECTOR", IMUSensor::GAME_ROTATION_VECTOR)
        .value("GEOMAGNETIC_ROTATION_VECTOR", IMUSensor::GEOMAGNETIC_ROTATION_VECTOR)
        .value("ARVR_STABILIZED_ROTATION_VECTOR", IMUSensor::ARVR_STABILIZED_ROTATION_VECTOR)
        .value("ARVR_STABILIZED_GAME_ROTATION_VECTOR", IMUSensor::ARVR_STABILIZED_GAME_ROTATION_VECTOR)
