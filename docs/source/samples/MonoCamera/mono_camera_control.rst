...
.. tabs::
    ...
    .. tab:: C++
        ...
        Also `available on GitHub <https://github.com/luxonis/depthai-core/blob/main/examples/src/MonoCamera/mono_camera_control.cpp>`__

        .. literalinclude:: ../../../../depthai-core/examples/src/MonoCamera/mono_camera_control.cpp
           :language: cpp
           :linenos:
