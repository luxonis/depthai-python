...
void init_binding_device(pybind11::module& m){
    ...
    py::enum_<CameraControl::Command>(m, "Isp3A")
        .value("CMD_START_STREAM",             CameraControl::Command::START_STREAM)
        .value("CMD_STOP_STREAM",              CameraControl::Command::STOP_STREAM)
        .value("CMD_REQUEST_STILL",            CameraControl::Command::REQUEST_STILL)
        .value("CMD_MOVE_LENS",                CameraControl::Command::MOVE_LENS)
        .value("CMD_FOCUS_TRIGGER",            CameraControl::Command::FOCUS_TRIGGER)
        .value("CMD_AE_MANUAL",                CameraControl::Command::AE_MANUAL)
        .value("CMD_AE_AUTO",                  CameraControl::Command::AE_AUTO)
        .value("CMD_SET_AWB_MODE",             CameraControl::Command::SET_AWB_MODE)
        .value("CMD_SCENE_MODES",              CameraControl::Command::SCENE_MODES)
        .value("CMD_ANTIBANDING_MODES",        CameraControl::Command::ANTIBANDING_MODES)
        .value("CMD_EXPOSURE_COMPENSATION",    CameraControl::Command::EXPOSURE_COMPENSATION)
        .value("CMD_AE_LOCK",                  CameraControl::Command::AE_LOCK)
        .value("CMD_AE_TARGET_FPS_RANGE",      CameraControl::Command::AE_TARGET_FPS_RANGE)
        .value("CMD_AWB_LOCK",                 CameraControl::Command::AWB_LOCK)
        .value("CMD_CAPTURE_INTENT",           CameraControl::Command::CAPTURE_INTENT)
        .value("CMD_CONTROL_MODE",             CameraControl::Command::CONTROL_MODE)
        .value("CMD_FRAME_DURATION",           CameraControl::Command::FRAME_DURATION)
        .value("CMD_SENSITIVITY",              CameraControl::Command::SENSITIVITY)
        .value("CMD_EFFECT_MODE",              CameraControl::Command::EFFECT_MODE)
        .value("CMD_AF_MODE",                  CameraControl::Command::AF_MODE)
        .value("CMD_NOISE_REDUCTION_STRENGTH", CameraControl::Command::NOISE_REDUCTION_STRENGTH)
        .value("CMD_SATURATION",               CameraControl::Command::SATURATION)
        .value("CMD_BRIGHTNESS",               CameraControl::Command::BRIGHTNESS)
        .value("CMD_STREAM_FORMAT",            CameraControl::Command::STREAM_FORMAT)
        .value("CMD_CAM_RESOLUTION",           CameraControl::Command::CAM_RESOLUTION)
        .value("CMD_SHARPNESS",                CameraControl::Command::SHARPNESS)
        .value("CMD_CUSTOM_USECASE",           CameraControl::Command::CUSTOM_USECASE)
        .value("CMD_CUSTOM_CAPT_MODE",         CameraControl::Command::CUSTOM_CAPT_MODE)
        .value("CMD_CUSTOM_EXP_BRACKETS",      CameraControl::Command::CUSTOM_EXP_BRACKETS)
        .value("CMD_CUSTOM_CAPTURE",           CameraControl::Command::CUSTOM_CAPTURE)
        .value("CMD_CONTRAST",                 CameraControl::Command::CONTRAST)
        .value("CMD_AE_REGION",                CameraControl::Command::AE_REGION)
        .value("CMD_AF_REGION",                CameraControl::Command::AF_REGION)
        .value("CMD_LUMA_DENOISE",             CameraControl::Command::LUMA_DENOISE)
        .value("CMD_CHROMA_DENOISE",           CameraControl::Command::CHROMA_DENOISE)
    ;
