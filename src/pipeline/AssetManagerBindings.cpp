...
void AssetManagerBindings::bind(pybind11::module& m){
    ...
    py::class_<AssetManager>(m, "AssetManager", DOC(dai, AssetManager))
        ...
        .def("add", static_cast<std::shared_ptr<dai::Asset> (AssetManager::*)(Asset)>(&AssetManager::add), py::arg("asset"), DOC(dai, AssetManager, add))
        .def("add", static_cast<std::shared_ptr<dai::Asset> (AssetManager::*)(const std::string&, Asset)>(&AssetManager::add), py::arg("key"), py::arg("asset"), DOC(dai, AssetManager, add, 2))
        .def("add", static_cast<std::shared_ptr<dai::Asset> (AssetManager::*)(const std::string& key, const std::string& path, int alignment)>(&AssetManager::add), py::arg("key"), py::arg("path"), py::arg("alignment") = 64, DOC(dai, AssetManager, add, 3))
        .def("add", static_cast<std::shared_ptr<dai::Asset> (AssetManager::*)(const std::string& key, const std::vector<std::uint8_t>& data, int alignment)>(&AssetManager::add), py::arg("key"), py::arg("data"), py::arg("alignment") = 64, DOC(dai, AssetManager, add, 4))
