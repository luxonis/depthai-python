...
void DeviceBootloaderBindings::bind(pybind11::module& m, void* pCallstack){
    ...
    deviceBootloader
      // Python only methods
        ...
        .def_static("saveDepthaiApplicationPackage", py::overload_cast<std::string, const Pipeline&, std::string, bool, std::string>(&DeviceBootloader::saveDepthaiApplicationPackage), py::arg("path"), py::arg("pipeline"), py::arg("pathToCmd") = "", py::arg("compress") = false, py::arg("applicationName") = "", DOC(dai, DeviceBootloader, saveDepthaiApplicationPackage))
        .def_static("saveDepthaiApplicationPackage", py::overload_cast<std::string, const Pipeline&, bool, std::string>(&DeviceBootloader::saveDepthaiApplicationPackage), py::arg("path"), py::arg("pipeline"), py::arg("compress"), py::arg("applicationName") = "", DOC(dai, DeviceBootloader, saveDepthaiApplicationPackage, 2))
        .def_static("createDepthaiApplicationPackage", py::overload_cast<const Pipeline&, std::string, bool, std::string>(&DeviceBootloader::createDepthaiApplicationPackage), py::arg("pipeline"), py::arg("pathToCmd") = "", py::arg("compress") = false, py::arg("applicationName") = "", DOC(dai, DeviceBootloader, createDepthaiApplicationPackage))
        .def_static("createDepthaiApplicationPackage", py::overload_cast<const Pipeline&, bool, std::string>(&DeviceBootloader::createDepthaiApplicationPackage), py::arg("pipeline"), py::arg("compress"), py::arg("applicationName") = "", DOC(dai, DeviceBootloader, createDepthaiApplicationPackage, 2))
        ...
        .def("flash", [](DeviceBootloader& db, std::function<void(float)> progressCallback, const Pipeline& pipeline, bool compress, std::string applicationName, Memory memory) { py::gil_scoped_release release; return db.flash(progressCallback, pipeline, compress, applicationName, memory); }, py::arg("progressCallback"), py::arg("pipeline"), py::arg("compress") = false, py::arg("applicationName") = "", py::arg("memory") = DeviceBootloader::Memory::AUTO, DOC(dai, DeviceBootloader, flash))
        .def("flash", [](DeviceBootloader& db, const Pipeline& pipeline, bool compress, std::string applicationName, Memory memory) { py::gil_scoped_release release; return db.flash(pipeline, compress, applicationName, memory); }, py::arg("pipeline"), py::arg("compress") = false, py::arg("applicationName") = "", py::arg("memory") = DeviceBootloader::Memory::AUTO, DOC(dai, DeviceBootloader, flash, 2))

        .def("readApplicationInfo", [](DeviceBootloader& db) { py::gil_scoped_release release; return db.readApplicationInfo(); }, DOC(dai, DeviceBootloader, readApplicationInfo))
        ...
        .def("flashDepthaiApplicationPackage", [](DeviceBootloader& db, std::function<void(float)> progressCallback, std::vector<uint8_t> package, Memory memory) { py::gil_scoped_release release; return db.flashDepthaiApplicationPackage(progressCallback, package, memory); }, py::arg("progressCallback"), py::arg("package"), py::arg("memory") = DeviceBootloader::Memory::AUTO, DOC(dai, DeviceBootloader, flashDepthaiApplicationPackage))
        .def("flashDepthaiApplicationPackage", [](DeviceBootloader& db, std::vector<uint8_t> package, Memory memory) { py::gil_scoped_release release; return db.flashDepthaiApplicationPackage(package, memory); }, py::arg("package"), py::arg("memory") = DeviceBootloader::Memory::AUTO, DOC(dai, DeviceBootloader, flashDepthaiApplicationPackage, 2))
