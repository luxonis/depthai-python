...
if os.environ.get('READTHEDOCS', None) == 'True': 
    breathe_projects = {"depthai-core": "_depthai-core/doxygen/xml"} 
# Otherwise the path should be set upfront using define "-Dbreathe_projects.depthai-core" when calling sphinx
