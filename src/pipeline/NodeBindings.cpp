...
void NodeBindings::bind(pybind11::module& m){
    ...
    py::class_<ColorCamera, Node, std::shared_ptr<ColorCamera>>(m, "ColorCamera", DOC(dai, node, ColorCamera))
        ...
        .def("setPreviewSize", (void(ColorCamera::*)(int,int))&ColorCamera::setPreviewSize, py::arg("width"), py::arg("height"), DOC(dai, node, ColorCamera, setPreviewSize))
        .def("setPreviewSize", (void(ColorCamera::*)(std::tuple<int,int>))&ColorCamera::setPreviewSize, py::arg("size"), DOC(dai, node, ColorCamera, setPreviewSize, 2))
        .def("setVideoSize", (void(ColorCamera::*)(int,int))&ColorCamera::setVideoSize, py::arg("width"), py::arg("height"), DOC(dai, node, ColorCamera, setVideoSize))
        .def("setVideoSize", (void(ColorCamera::*)(std::tuple<int,int>))&ColorCamera::setVideoSize, py::arg("size"), DOC(dai, node, ColorCamera, setVideoSize, 2))
        .def("setStillSize", (void(ColorCamera::*)(int,int))&ColorCamera::setStillSize, py::arg("width"), py::arg("height"), DOC(dai, node, ColorCamera, setStillSize))
        .def("setStillSize", (void(ColorCamera::*)(std::tuple<int,int>))&ColorCamera::setStillSize, py::arg("size"), DOC(dai, node, ColorCamera, setStillSize, 2))
        ...
        .def("setIspScale", (void(ColorCamera::*)(int,int))&ColorCamera::setIspScale, py::arg("numerator"), py::arg("denominator"), DOC(dai, node, ColorCamera, setIspScale))
        .def("setIspScale", (void(ColorCamera::*)(std::tuple<int,int>))&ColorCamera::setIspScale, py::arg("scale"), DOC(dai, node, ColorCamera, setIspScale, 2))
        .def("setIspScale", (void(ColorCamera::*)(int,int,int,int))&ColorCamera::setIspScale, py::arg("horizNum"), py::arg("horizDenom"), py::arg("vertNum"), py::arg("vertDenom"), DOC(dai, node, ColorCamera, setIspScale, 3))
        .def("setIspScale", (void(ColorCamera::*)(std::tuple<int,int>,std::tuple<int,int>))&ColorCamera::setIspScale, py::arg("horizScale"), py::arg("vertScale"), DOC(dai, node, ColorCamera, setIspScale, 4))
    ...
    py::class_<StereoDepth, Node, std::shared_ptr<StereoDepth>>(m, "StereoDepth", DOC(dai, node, StereoDepth))
        ...
        .def("setDepthAlign",           (void(StereoDepth::*)(StereoDepthProperties::DepthAlign))&StereoDepth::setDepthAlign, py::arg("align"), DOC(dai, node, StereoDepth, setDepthAlign))
        .def("setDepthAlign",           (void(StereoDepth::*)(CameraBoardSocket))&StereoDepth::setDepthAlign, py::arg("camera"), DOC(dai, node, StereoDepth, setDepthAlign, 2))
