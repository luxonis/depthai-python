29.1 - Object tracker on RGB camera
===================================
...
Also `available on GitHub <https://github.com/luxonis/depthai-python/blob/gen2_develop/examples/29_1_object_tracker.py>`__

.. literalinclude:: ../../../examples/29_1_object_tracker.py
   :language: python
   :linenos:
