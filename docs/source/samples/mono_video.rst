...
.. tabs::
    ...
    .. tab:: C++
        ...
        Also `available on GitHub <https://github.com/luxonis/depthai-core/blob/main/examples/src/mono_video.cpp>`__

        .. literalinclude:: ../../../depthai-core/examples/src/mono_video.cpp
           :language: cpp
           :linenos:
